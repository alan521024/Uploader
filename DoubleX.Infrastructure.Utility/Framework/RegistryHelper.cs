...
namespace DoubleX.Infrastructure.Utility
{
    ...
    public class RegistryHelper
    {
        /// <summary>
        /// 读取注册表值
        /// eg:读取的注册表中HKEY_LOCAL_MACHINE\SOFTWARE目录下的XXX目录中名称为name的注册表值； 
        /// </summary>
        /// <param name="name"></param>
        /// <returns></returns>
        public static string RegistGet(string name, string rootKey)
        {
            string registData;
        ...
        public static void RegeditWrite(string name, string tovalue)
        {
        ...
        /// </summary>
        /// <param name="name"></param>
        public static void RegistDelete(string name)
        {
            string[] aimnames;
            RegistryKey hkml = Registry.LocalMachine;
            RegistryKey software = hkml.OpenSubKey("SOFTWARE", true);
        ...
        /// <param name="name"></param>
        /// <returns></returns>
        public static bool RegeditIsExit(string name)
        {
            bool _exit = false;
            string[] subkeyNames;
            RegistryKey hkml = Registry.LocalMachine;
    ...
    public class RegisterUtil
    {
        ...
        public RegisterUtil(string subKey)
        {
            _subkey = subKey;
