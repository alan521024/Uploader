...
namespace DoubleX.Infrastructure.Utility
{
    ...
    public static class DateTimeHelper
    {
        ...
        #region 时间操作(GetByXXX,GetToXXX,GetByXXXXToXXX)
        ...
        /// <returns></returns>
        public static DateTimeDifferenceInfo GetToDifference(DateTime startDateTime, DateTime? endDateTime = null)
        {
        ...
        #region 扩展方法(DateTime Format DateTime)
