...
namespace DoubleX.Infrastructure.Utility
{
        ...
        private static Font[] fonts =
    {
       ...
       new Font(new FontFamily("Comic Sans MS"), 10 + Next(1),System.Drawing.FontStyle.Regular)
        ...
        /// <returns></returns>
        public static BitmapImage CreateBitmapImage(string content, int imageWidth = 0, int imageHeight = 0, int letterWidth = 16, int letterHeight = 20)
        {
            Bitmap bitmap = Create(content, imageWidth: imageWidth, imageHeight: imageHeight, letterWidth: letterWidth, letterHeight: letterHeight);
        ...
        /// <param name="letterHeight"></param>
        /// <returns></returns>
        public static Bitmap Create(string content, int imageWidth = 0, int imageHeight = 0, int letterWidth = 16, int letterHeight = 20)
        {
            ...
            if (imageWidth == 0)
            {
                imageWidth = content.Length * letterWidth;
            }

            if (imageHeight == 0)
            {
                imageHeight = letterHeight;
            }
            ...
            for (int i = 0; i < content.Length; i++)
            {
                ...
                string str_char = content.Substring(i, 1);
            ...
            graphics.DrawRectangle(new Pen(Color.LightGray, 1), 0, 0, imageWidth - 1, (imageHeight - 1));
            return image;
        }
    ...
    public class StringRandHelper
    {
        ...
        /// </summary>  
        /// <param name="IntStr">生成长度</param>  
        public static string StrAndNumber(int Length)
        {
